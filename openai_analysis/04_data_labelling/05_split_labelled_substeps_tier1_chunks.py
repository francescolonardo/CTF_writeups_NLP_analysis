...
base_path = "../data/list_substeps_tier1"
...
categories = set()
for file in files:
    if file.startswith("list_substeps_tier1_") and file.endswith(".json"):
        category = file.replace("list_substeps_tier1_", "").replace(".json", "")
