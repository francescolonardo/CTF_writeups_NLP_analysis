...
Upon submitting the malicious file to the application, it indeed executed the code and granted me remote access to the server, confirming the vulnerability. To obtain the flag for the Web Exploitation challenge, I needed to use the RCE vulnerability to execute arbitrary commands on the server.

After uploading a suitable payload, I executed the commands and obtained sensitive data, including the flag for the Web Exploitation challenge.
